...
namespace lvm
{
    ...
    void ExecutionUnit::execute() const
    {
        ...
        static void* dispatchTable[] = {
            ...
            DISPATCH_TABLE_ENTRY(JUL), DISPATCH_TABLE_ENTRY(JUL),DISPATCH_TABLE_ENTRY(JULE),DISPATCH_TABLE_ENTRY(JUG),
            ...
            DISPATCH_TABLE_ENTRY(OPEN),DISPATCH_TABLE_ENTRY(READ),DISPATCH_TABLE_ENTRY(WRITE),
